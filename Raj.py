...
\033[1;91m    ║══▒═🌺═▒═🌺═▒═══🌹═🌹═🌹════════════🌹═══🌹═══🌺═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗 𝕂ℍ𝕆ℕ𝔻𝕆𝕂𝔸ℝ ℝ𝔸𝕁       ║    
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ☪ 𝖀𝖘𝖆𝖒𝖆 𝕿𝖗𝖎𝖈𝖐𝖊𝖗            ║  
\033[1;96m    ║✯  𝕂ℍ𝕆ℕ𝔻𝕆𝕂𝔸ℝ ℝ𝔸𝕁  ║
\033[1;91m    ║══▒═🌻═▒═🌻═▒═══😘═¤😍═🌹════════════🌹═══🌹═══🌹═══║
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE 𝕂ℍ𝕆ℕ𝔻𝕆𝕂𝔸ℝ ℝ𝔸𝕁
\033[1;97m************************************************
...
def pilih_super():
	...
	print "  \033[1;91m«---•◈•---Developed By 𝑲𝑯𝑶𝑵𝑫𝑶𝑲𝑨𝑹 𝑹𝑨𝑱 --•◈•---»" #Dev:RAJ
